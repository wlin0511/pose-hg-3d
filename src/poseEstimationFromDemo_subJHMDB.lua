...
local txt_file = '/mnt/Projects/CV-008_Students/ActionRecognitionProjects/TrainingData/Splits/JHMDB_split/sub_splits_Lin/rgb_testlist_subsplit1.txt'

img_dir_keyword = "ActionRecognitionProjects/TrainingData/Intermediate_results/JHMDB_CroppedImg"
result_dir_keyword = "ActionRecognitionProjects/TrainingData/JHMDB/3DPose/"
...
for lineid, linecontent in pairs(lines_) do
  ...
  className = ({['1']="catch", ['2']="climb_stairs", ['3']="golf", ['4']="jump", ['5']="kick_ball", ['6']="pick", ['7']="pullup", ['8']="push", ['9']="run", ['10']="shoot_ball",['11']="swing_baseball", ['12']="walk"})[classid];
  
  -- replace 'ActionRecognitionProjects/TrainingData/Intermediate_results/JHMDB_CroppedImg'  with   'ActionRecognitionProjects/TrainingData/JHMDB/3DPose/className' .. 
  ...
  for fileid, filename in pairs(allFileNames) do
	  ...
	  if string.find(filename, '.png') then
	    points_filename = string.sub(filename, 1, -5)  -- remove '.png'
